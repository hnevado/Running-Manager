                    ...
                    @foreach ($runners as $runner)
                        <tr>
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 w-10 h-10">
                                        <img class="w-10 h-10 rounded-full" src="{{ $runner->profile_image }}" alt="">
                                    </div>

                                    <div class="ml-4">
                                        <div class="text-sm font-medium leading-5 text-gray-900">{{ $runner->name }}</div>
                            ...
                            <td class="px-6 py-4 text-sm font-medium leading-5 text-right whitespace-no-wrap border-b border-gray-200">
                                <a href="{{ route('runners-recruitment', $runner->id) }}" class="text-indigo-600 hover:text-indigo-900">
                                    DETALLES
                                </a> |
